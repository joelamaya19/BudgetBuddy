...
export const ADD_TRANSACTION = gql`
  mutation addTransaction($accountId: ID!, $categoryName: String!, $name: String!, $amount: Int!) {
    addTransaction(accountId: $accountId, categoryName: $categoryName, name: $name, amount: $amount) {
      _id
      categoryName
      amount
      createdAt
