...
export const ADD_TRANSACTION = gql`
  mutation addTransaction($categoryId: ID!, $name: String!, $amount: Int!, $accountId: ID!) {
    addTransaction(categoryId: $categoryId, name: $name, amount: $amount, accountId: $accountId) {
      _id
      amount
      createdAt
      name
